...
@section('content')
    <h1 class="text-lg font-semibold text-gray-900">{{ __('Đặt lại mật khẩu') }}</h1>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="mt-6 space-y-4">
        ...
        <div>
            ...
            <input
                id="email" type="email" name="email" value="{{ old('email', $request->query('email')) }}" required autofocus autocomplete="username"
